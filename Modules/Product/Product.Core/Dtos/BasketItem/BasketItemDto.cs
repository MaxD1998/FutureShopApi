...
public class BasketItemDto
{
    ...
    public static Expression<Func<BasketItemEntity, BasketItemDto>> Map(Guid? favouriteId) => entity => new()
    {
        Id = entity.Id,
        ProductFileId = entity.Product.ProductPhotos.AsQueryable().Select(x => x.FileId).FirstOrDefault(),
        ProductId = entity.ProductId,
        ProductIsInPurchaseList = entity.Product.PurchaseListItems.AsQueryable().Any(x => x.PurchaseListId == favouriteId),
