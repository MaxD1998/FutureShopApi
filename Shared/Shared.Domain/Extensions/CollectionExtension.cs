...
public static class CollectionExtension
{
    ...
    public static void UpdateEntities<TEntity>(this ICollection<TEntity> entities, IReadOnlyCollection<TEntity> updateEntities) where TEntity : IEntity, IUpdate<TEntity>
    {
        foreach (var updateEntity in updateEntities)
        {
            var result = entities.FirstOrDefault(x => x.Id == updateEntity.Id && x.Id != Guid.Empty);
