...
public class BasketController(IBasketSerivce basketSerivce) : ShopModuleBaseController
{
    ...
    [HttpPost]
    [ProducesResponseType(typeof(BasketFormResponseDto), StatusCodes.Status200OK)]
    public Task<IActionResult> CreateAsync([FromBody] BasketFormRequestDto dto, CancellationToken cancellationToken = default)
    ...
    [HttpPut("{id:guid}")]
    [ProducesResponseType(typeof(BasketFormResponseDto), StatusCodes.Status200OK)]
    public Task<IActionResult> UpdateAsync([FromRoute] Guid id, [FromBody] BasketFormRequestDto dto, CancellationToken cancellationToken = default)
