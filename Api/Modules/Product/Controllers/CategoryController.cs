...
[Role(UserType.User)]
public class CategoryController(IFluentValidatorFactory fluentValidatorFactory, IMediator mediator, ICategoryService categoryService) : ProductModuleBaseController(fluentValidatorFactory, mediator)
{
